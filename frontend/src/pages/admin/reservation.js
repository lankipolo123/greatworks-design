...
import { reservations, locations, rooms, users as usersApi } from '/src/service/api.js';
...
import { isAdmin, isModerator } from '/src/service/api-core.js';
  ...
  render() {
    return html`
      ...
      <app-dialog
        ...
        description="Choose how to create this reservation"
        size="small"
        styleMode="compact"
        .hideFooter=${true}
        .closeOnOverlay=${true}
      ...
      <app-dialog
        ...
        title="Select User"
        description="Choose an existing user to reserve for"
        size="medium"
        styleMode="compact"
        .hideFooter=${true}
        .closeOnOverlay=${true}
      ...
      <app-dialog
        ...
        title="${this._bookSelectedUser ? `Reserve for ${this._bookSelectedUser.name}` : 'Add Reservation'}"
        ...
        <book-someone-form .rooms=${this.roomsList} .selectedUser=${this._bookSelectedUser}>
          <app-button
            slot="actions"
            type="warning"
            size="medium"
